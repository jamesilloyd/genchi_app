...
class _PostTaskAndHirerScreenState extends State<PostTaskAndHirerScreen> {
  ...
  Widget build(BuildContext context) {
          ...
          builder: (BuildContext context) {
            return ModalProgressHUD(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  Center(child: Text('HIRER DETAILS', style: TextStyle(fontSize: 20),)),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: Stack(
                      ...
                      children: <Widget>[
                        LargeDisplayPicture(
                          imageUrl: accountService.currentAccount.displayPictureURL,
                          height: 0.25,
                          isEdit: true,
                        ),
                        Positioned(
                  ...
                  SizedBox(height: 15,),
                  Center(child: Text('TASK DETAILS', style: TextStyle(fontSize: 20),)),
                  EditAccountField(
                    field: 'Title',
                    onChanged: (value) {
                      changesMade = true;
                  ...
                  EditAccountField(
                    ...
                    hintText: 'Provide further details of the opportunity, urls etc.',
    ...
    ///Link was valid
                          ...
                          await firestoreAPI.updateUser(user: newHirer, uid: accountService.currentAccount.id);
